...
# CONFIG SECTION:
INPUT_VCF = "Results/indels.vcf"

RESULTS_DIR = "Results"
SUMMARY_DIR = "Summaries"

PROGRESS_UPDATE_INTERVAL = 20000
...
def process_vcf(input_vcf):
    ...
    output_vcf = os.path.join(RESULTS_DIR, f"{base_name}_ID_HC.vcf")
    summary_file = os.path.join(SUMMARY_DIR, f"{base_name}_ID_HC_summary.txt")
